# Examen Práctico Final (C4) — Temática: FLORISTERÍA
...
| `internal/models/arreglo.go` | BLOQUEADO | Modelo de ejemplo (Entidad A). |
| `internal/models/estados.go` | BLOQUEADO | Constantes de estado del encargo. |
| `internal/models/cliente.go` | **TAREA CP1** | Complete los campos. |
| `internal/models/encargo.go` | **TAREA CP1** | Complete los campos. |
...
| `internal/storage/arreglo_gorm.go` | BLOQUEADO | Implementación GORM de ejemplo. |
| `internal/storage/cliente_gorm.go` | **TAREA CP1** | Impleméntela. |
| `internal/storage/encargo_gorm.go` | **TAREA CP2** | Impleméntela. |
| `internal/services/errores.go` | BLOQUEADO | Errores de dominio. |
| `internal/services/arreglo_service.go` | BLOQUEADO | Service de ejemplo. |
| `internal/services/cliente_service.go` | **TAREA CP1** | Impleméntelo. |
| `internal/services/encargo_service.go` | **TAREA CP2** | Las 5 reglas de negocio viven aquí. |
...
| `internal/handlers/arreglo_handler.go` | BLOQUEADO | Handler de ejemplo (mapeo de errores). |
| `internal/handlers/cliente_handler.go` | **TAREA CP1** | Impleméntelo. |
| `internal/handlers/encargo_handler.go` | **TAREA CP3** | Impleméntelo. |
...
El seeder carga 4 arreglos (una inactiva) la primera vez.
